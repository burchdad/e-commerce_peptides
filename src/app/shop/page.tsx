...
export default async function ShopPage() {
  ...
  return (
    <div className="space-y-8" data-mission-control-ticket="whr_1781918482218_5f91fa75af50">
      <div>
        <h1 className="section-title">Shop</h1>
        <p className="mt-3 max-w-2xl text-[var(--color-muted)]">Explore all available research products in one collection. GLP products are now available.</p>
      </div>
