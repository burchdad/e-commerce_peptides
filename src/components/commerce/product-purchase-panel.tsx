...
export const ProductPurchasePanel = ({ product }: { product: Product }) => {
  ...
  return (
    <div className="rounded-[1.6rem] border border-[var(--color-border)] bg-white p-8 shadow-[0_14px_35px_rgba(17,17,17,0.08)]">
      ...
      <div className="mt-7">
        ...
        <div className="mt-3 inline-flex items-center rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-soft)] p-1">
          <button
            type="button"
            className="h-11 w-11 rounded-lg text-xl text-[var(--color-text)] transition hover:bg-white disabled:cursor-not-allowed disabled:opacity-45"
          ...
          <button
            type="button"
            className="h-11 w-11 rounded-lg text-xl text-[var(--color-text)] transition hover:bg-white"
            onClick={() => updateQuantity(quantity + 1)}
      ...
      <div className="mt-6 rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-soft)] p-4">
