...
export const categories: Category[] = [
  ...
  },
  {
    ...
    name: 'Anti-Aging',
    slug: 'anti-aging',
    description: 'Future category for age-related research products.',
    isFuture: true,
  },
  {
    id: 'cat-skin-support',
  ...
  },
  {
    ...
    name: 'Recovery',
    slug: 'recovery',
    description: 'Future category for cellular recovery and resilience research.',
    isFuture: true,
  },
  {
...
export const products: Product[] = [
  {
    ...
    subtitle: '5mg Lyophilized GLP Research Compound',
    shortDescription: 'Precision-filled vial for controlled GLP pathway research protocols.',
    longDescription:
      'Retrafin-5 is prepared in small-batch production with strict lot traceability. Designed for laboratory and analytical research environments requiring consistency and premium handling standards.',
    price: 149,
    compareAtPrice: 179,
    images: ['/products/glp-1.jpg', '/products/glp-2.jpg'],
    stockQuantity: 34,
    sku: 'GLP-RET-005',
    badge: 'Featured',
  ...
  },
  {
    ...
    slug: 'retrafin-10',
    category: 'glp-products',
    subtitle: '10mg Lyophilized GLP Research Compound',
    shortDescription: 'Higher-capacity format for expanded research planning.',
    longDescription:
      'Retrafin-10 offers the same premium sourcing and sterile handling standards as the 5mg format while providing additional capacity for extended bench workflows.',
    price: 229,
    images: ['/products/glp-2.jpg', '/products/glp-3.jpg'],
    stockQuantity: 21,
    sku: 'GLP-RET-010',
    badge: 'Best Value',
    includesComplimentaryKit: true,
  ...
  },
  {
    ...
    slug: 'auralide-6',
    category: 'glp-products',
    subtitle: '6mg GLP Analog Research Vial',
    shortDescription: 'Balanced quantity profile for routine comparative studies.',
    longDescription:
      'Auralide-6 is produced for laboratories seeking repeatable sample behavior in GLP-related exploratory frameworks and non-clinical analysis.',
    price: 168,
    images: ['/products/glp-3.jpg'],
    stockQuantity: 17,
    sku: 'GLP-AUR-006',
    includesComplimentaryKit: true,
    attributes: [
      { label: 'Amount', value: '6mg' },
  ...
  },
  {
    ...
    slug: 'auralide-12',
    category: 'glp-products',
    subtitle: '12mg GLP Analog Research Vial',
    shortDescription: 'Premium high-capacity format for larger protocol designs.',
    longDescription:
      'Auralide-12 extends the Auralide profile into a larger vial format while maintaining traceable packaging and controlled cold-chain preparation standards.',
    price: 279,
    compareAtPrice: 309,
    images: ['/products/glp-4.jpg'],
    stockQuantity: 10,
    sku: 'GLP-AUR-012',
    badge: 'Limited Lot',
    includesComplimentaryKit: true,
    attributes: [
      { label: 'Amount', value: '12mg' },
  ...
  },
  {
    ...
    price: 6,
    images: ['/products/accessory-4.jpg'],
    stockQuantity: 190,
    sku: 'ACC-APP-010',
    includesComplimentaryKit: false,
    attributes: [
  ...
  },
  {
    ...
    price: 14,
    images: ['/products/accessory-5.jpg'],
    stockQuantity: 140,
    sku: 'ACC-INS-006',
    includesComplimentaryKit: false,
    attributes: [
  ...
  },
  {
    ...
    longDescription: 'Accessory add-on sold separately.',
    price: 5,
    images: ['/products/accessory-6.jpg'],
    stockQuantity: 180,
    sku: 'ACC-SVC-001',
    includesComplimentaryKit: false,
    attributes: [
  ...
  },
  {
    ...
    longDescription: 'Accessory add-on sold separately.',
    price: 8,
    images: ['/products/accessory-7.jpg'],
    stockQuantity: 120,
    sku: 'ACC-AAS-005',
    includesComplimentaryKit: false,
    attributes: [
  ...
  },
  {
    ...
    price: 39,
    images: ['/products/accessory-8.jpg'],
    stockQuantity: 75,
    sku: 'ACC-KIT-FULL',
    badge: 'Popular',
    includesComplimentaryKit: false,
